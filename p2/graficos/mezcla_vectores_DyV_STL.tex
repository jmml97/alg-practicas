...
\begin{picture}(5760.00,4320.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \colorrgb{0.30,0.30,0.30}%
      \put(3506,220){\makebox(0,0){\strut{}Número de vectores (k)}}%
      \colorrgb{0.30,0.30,0.30}%
      \put(3506,3989){\makebox(0,0){\strut{}Eficiencia empírica mezcla_vectores_DyV_STL}}%
      \csname LTb\endcsname%
      \put(4376,3486){\makebox(0,0)[r]{\strut{}Algoritmo divide y vencerás STL n = 10}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{graficos/./../mezcla_vectores_DyV_STL}}%
    \gplfronttext
  \end{picture}%
\endgroup
