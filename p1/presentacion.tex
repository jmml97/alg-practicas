...
\only<2>{
\vspace{-9em}
\textbf{Algoritmos que son $\boldsymbol{O(n^2)}$}
}
...
\only<4>{
\vspace{-9em}
\textbf{Algoritmos que son $\boldsymbol{O(n\log n)}$}
}
...
\only<6>{
\vspace{-9em}
\textbf{Algoritmos que son $\boldsymbol{O(n^3)}$}
}
...
\only<8>{
\vspace{-9em}
\textbf{Algoritmos que son $\boldsymbol{O(2^n)}$}
}
