...
#for archivo in $(ls algoritmos_cpp);
#do
#./creacion_tiempos.sh $archivo datos ejecutables 5000 100000    
#done
...
#./creacion_tiempos.sh insercion.cpp datos ejecutables 2000 51000 2000
...
#./creacion_tiempos.sh seleccion.cpp datos ejecutables 2000 51000 2000
